...
export const BookCheckoutPage = () => {
  ...
  const [isLoadingCurrentLoansCount, setIsLoadinCurrentLoansCount] =
    useState(true);
  ...
  // fetch user's current number of loans 
  useEffect(() => {
    const fetchUserCurrentLoansCount = async () => {
      ...
      setIsLoadinCurrentLoansCount(false);
    };
      ...
      <div className="container d-none d-lg-block">
        <div className="row mt-5">
          <div className="col-sm-2 col-md-2">
            {book?.img ? (
              <img src={book?.img} width="226" height="349" />
            ) : (
              <img
